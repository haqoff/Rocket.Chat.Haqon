...
using Rocket.Chat.Haqon.Helpers;
using Rocket.Chat.Haqon.Interfaces;
using Rocket.Chat.Haqon.Models;
using Rocket.Chat.Haqon.Models.LoginOptions;
...
namespace Rocket.Chat.Net.Tests.Driver
{
    ...
    public class RocketChatDriverFacts
    {
        ...
        public async Task Login_with_email()
        {
            ...
            // Act
            await _driver.LoginWithEmailAsync(new EmailLoginOption { Email = email, Password = password });
